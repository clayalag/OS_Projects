...
class Packet:
    ...
    def getEncodedPacket(self):
        """returns a seriliazed packet ready to send through the network. First you need to build the packets.  See BuildXPacket functions."""
    ...
    def getFileInfo(self):
        ...
        if "fname" and "fsize" in self.packet:
